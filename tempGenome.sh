...
export DATA_DIR=/media/_raid1/raid1/alex/sequencing/cll/data/exomes
...
export TARGET_DIR=/media/_raid1/raid1/alex/sequencing/cll/runs/genome_$CURRENT_DATE
...
# BWA_DIR
export BWA_DIR=/media/_raid1/raid1/sequencing/apps/alignment/bwa-0.6.2

# SAM_DIR
export SAM_DIR=/media/_raid1/raid1/sequencing/apps/post_processing/samtools-0.1.18

# PICARD_DIR
export PICARD_DIR=/media/_raid1/raid1/sequencing/apps/post_processing/picard-tools-1.78

# GATK_DIR
export GATK_DIR=/media/_raid1/raid1/sequencing/apps/post_processing/GenomeAnalysisTK-2.1-11-g13c0244

# SNPEFF_DIR
export SNPEFF_DIR=/media/_raid1/raid1/sequencing/apps/annotation/snpEff_3_1

# VAAST
export VAAST=/media/_raid1/raid1/sequencing/apps/analysis/VAAST/VAAST_RC_1.0.4/bin/VAAST

# VAAST_vaast_converter
export VAAST_vaast_converter=/media/_raid1/raid1/sequencing/apps/analysis/VAAST/VAAST_RC_1.0.4/bin/vaast_tools/vaast_converter

# VAAST_VST
export VAAST_VST=/media/_raid1/raid1/sequencing/apps/analysis/VAAST/VAAST_RC_1.0.4/bin/VST

# VAAST_vaast_sort_gff
export VAAST_vaast_sort_gff=/media/_raid1/raid1/sequencing/apps/analysis/VAAST/VAAST_emailed/vaast_sort_gff

# VAAST_VAT
export VAAST_VAT=/media/_raid1/raid1/sequencing/apps/analysis/VAAST/VAAST_RC_1.0.4/bin/VAT

# VAAST_QC
export VAAST_QC=/media/_raid1/raid1/sequencing/apps/analysis/VAAST/VAAST_RC_1.0.4/bin/vaast_tools/quality-check.pl

# Paths to reference files:
REF_DIR=/media/_raid1/raid1/sequencing/reference/gatk_bundle/gatk_bundle_04_Oct_2012
# --- Reference genomes ----
# REF_FASTA
...
# ---- snpEff ----
# GWAS_CAT
export GWAS_CAT=/media/_raid1/raid1/sequencing/reference/other/gwascatalog.txt
# DBNSFP
export DBNSFP=/media/_raid1/raid1/sequencing/reference/other/dbNSFP2.0b3.txt

# ---- VAAST ----
# VAAST_BACKGROUND
export VAAST_BACKGROUND=/media/_raid1/raid1/sequencing/reference/background/vaast/1KG_refGene_Dec2011_CGDiv_NHLBI_NoCall.cdr
# VAAST_FEATURES
export VAAST_FEATURES=/media/_raid1/raid1/sequencing/reference/vaast/refGene_hg19.gff3

s=`basename $0`
/media/_raid1/raid1/sequencing/apps/wrapper/genepi_ngs_scripts/best_practice_v4.sh >$s.log 2>$s.err.log